...
from wespeaker.models.loss import Angleproto 
...
def train(config='conf/config.yaml', **kwargs):
    ...
    model.add_module("projection", None)
    if rank == 0:
        # print model
    ...
    #criterion = getattr(torch.nn, configs['loss']['cls'])(**configs['loss']['cls_args'])
    ...
    if rank == 0:
        ...
        header = ['Epoch', 'Batch', 'Lr',  'Loss_cls']

...
cosine_similarity = np.diagonal(np.matmul(enrol,test.T)).reshape((1,40))

fig, ax = plt.subplots(figsize=(8, 2))

# 绘制热力图
cax = ax.imshow(cosine_similarity, cmap='gist_heat', aspect='auto')
ax.yaxis.set_visible(False)
cbar = fig.colorbar(cax, orientation='horizontal')
plt.savefig('/hpctmp/ma_yi/exp/vox2_2pooling_cstrPho0.0007_HardDiff0.00001_selfcstr0.0001/embeddings/vox1_O/target.png')
